function UserProfile2() {
    const name = "The Emperor Jones";
    const bio = "Full-stack developer passionate about creating cat-friendly applications.";
    const profileImage = "https://images.pexels.com/photos/20787/pexels-photo.jpg";
